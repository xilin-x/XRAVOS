...
from dataset.range_transform import xray_normalization, xray_mean
...
class XRayDataset(Dataset):
    ...
    def __init__(self, im_root, gt_root, max_jump, subset=None):
        ...
        self.pair_im_dual_transform = transforms.Compose(
            [
                transforms.RandomAffine(degrees=15, shear=10, interpolation=InterpolationMode.BICUBIC, fill=xray_mean),
            ]
        )
